...
1. Find the index of `BuyIntentData.dob_selling_script_hash` from Outputs.
2. Ensure the CKB stored in GroupOutput[0] meets or exceeds `BuyIntentData.min_capacity`, as it is used for spore minting.
